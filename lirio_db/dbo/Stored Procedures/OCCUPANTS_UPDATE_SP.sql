...
BEGIN
	...
	OCCUPANT_NAME = UPPER(@P_OCCUPANT_NAME), 
	OCCUPANT_MAIL = UPPER(@P_OCCUPANT_MAIL),
	MOBILE_NUMBER = @P_MOBILE_NUMBER,
	PHONE_NUMBER = @P_PHONE_NUMBER,
	RESPONSIBLE_NAME = UPPER(@P_RESPONSIBLE_NAME),
	RESPONSIBLE_MOBILE = UPPER(@P_RESPONSIBLE_MOBILE),
	COMMENTS = @P_COMMENTS
